...
/*
 * Вопросы:
 *   1. he, поставил в вывод basePrice в форме и просомотре
 *       а для вывода через поиск в справочнике избыточно ипользовать he.encode?
 *         форма: ...id="event-destination-1" type="text" name="event-destination" value="${getDestinationName(destinationInfo)}"....
 *         просмотр:
 ...
 *   2. нужна ли автоподстановка пункат назначения, если написано если не совпадает из-за регистра? глянут что в ТЗ и в заданиях...
 *   3. еже раз прочитать про требования к редактированию цены
 *
 * Заметки:
