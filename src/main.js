 ...
 *   3. нужен he? использую преобразование к числу и поиск строковый поиск по городам - перенести в вывод модифицируемых полей
 ...
 *   6. сортировку и фитрацию пернести в модель? и далее оповестить... из последнего лайва
 *   7. get template() срабатывет много раз изза обрачений к element, посмотреть что можно исключить из расчетов при отрисовке!
 *   8. нужна ли автоподстановка пункат назначения, если написано если не совпадает из-за регистра?
 *
 *
 * Заметки:
